...
class TestFitLognormalGPD:
    ...
    def test_no_tail_fallback(self):
        ...
        assert params["gpd_beta"] > 0, "Beta must be positive"
        assert params["gpd_beta"] >= 1000, "Beta should not be unrealistically small"
...
class TestSimulateSeverity:
    ...
    def test_default_tail_prob(self, sample_losses):
        ...
        np.random.seed(42)
        sevs = simulate_severity(25000, params_no_tail)
